            ...
            <Card className="flex flex-col items-center text-center py-8 relative overflow-hidden">
                ...
                <div className="relative z-10 w-full flex flex-col items-center">
                    ...
                    <div className="w-full flex justify-end gap-2 mb-2">
                        ...
                        >
                            <img src="/images_2/spuldze_simbols.png" alt="Hint" className="w-12 h-12 object-contain" />
                        </button>
                        <button
                    ...
                    {/* Status Indicator */}
                    <img
                        src={lastAnswerCorrect ? "/images/correct_answer.png" : "/images_2/incorrect_answer.png"}
