            ...
            <Card className="flex flex-col items-center text-center py-8 relative overflow-hidden">
                ...
                <div className="relative z-10 w-full flex flex-col items-center">
                    ...
                    <div className="w-full flex justify-end gap-2 mb-2">
                        ...
                        >
                            <img src="/images_4/spuldze_simbols.png" alt="Hint" className="w-12 h-12 object-contain" />
                        </button>
                        <button
                            onClick={() => setShowFact(!showFact)}
                            className={`p-1 rounded-full transition-colors ${showFact ? 'bg-orange-500 text-white' : 'bg-gray-100 text-gray-500'}`}
                        >
                            <img src="/images_2/extrainfo_simbols.png" alt="Fact" className="w-12 h-12 object-contain" />
                        </button>
                    </div>
                    ...
                    {/* Status Indicator */}
                    <img
                        src={lastAnswerCorrect ? "/images_3/correct_answer.png" : "/images_2/incorrect_answer.png"}
