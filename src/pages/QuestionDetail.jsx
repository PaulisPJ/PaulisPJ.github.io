            ...
            <Card className="flex flex-col min-h-[60vh] relative overflow-hidden">
                ...
                <div className="relative z-10 w-full flex flex-col h-full">
                    <div className="flex justify-between items-center mb-2">
                        <div
                            className="w-[60%] mr-0 font-bold text-[1.5rem] whitespace-pre-line text-white uppercase py-7 px-1 bg-center bg-no-repeat bg-[length:100%_80%] flex items-center justify-center drop-shadow-lg [-webkit-text-stroke:_0.3px_black] [text-shadow:_1px_1px_1px_rgba(0,0,0,0.3)]"
                            style={{ backgroundImage: "url('/images/delis_ar_naglam.png')" }}
                        >
