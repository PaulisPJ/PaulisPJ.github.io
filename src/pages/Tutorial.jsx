...
const Tutorial = () => {
    const { navigateTo, completeOnboarding, gameState, resetApp } = useGame();
            ...
            <Card className="flex flex-col items-center relative overflow-hidden">
                ...
                <div className="relative z-10 w-full flex flex-col items-center">
                            ...
                            >
                                ...
                                <div className="relative flex justify-center">
                                    ...
                                    <div className="absolute top-full right-0 -mr-9 mt-1 flex flex-col items-center">
                                        <svg width="24" height="40" viewBox="0 0 24 40" className="text-black overflow-visible mr-[37px]">
                                            <path d="M12 35 L12 5 M6 13 L12 5 L18 13" fill="none" stroke="currentColor" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                    {language === 'lv' ? (
                                        ...
                                        <div className="absolute top-full right-0 -mr-12 mt-[42px] flex flex-col items-center">
                    ...
                    <div className="w-full">
                        ...
                        {/* Reset Game Button - Only visible when onboarding is complete */}
                        {gameState.onboardingComplete && (
                            <button
                                onClick={() => {
                                    if (window.confirm(language === 'lv' ? 'UZMANĪBU!\n\nVai tiešām vēlaties dzēst spēles progresu?' : 'ATTENTION!\n\nAre you sure you want to reset the game?')) {
                                        resetApp();
                                    }
                                }}
                                className="w-full text-red-600 bg-red-50/80 py-3 mt-8 text-xl font-bold transition-transform shadow-md rounded-lg active:scale-95 duration-100 border-3 border-red-200"
                            >
                                {language === 'lv' ? 'Dzēst spēles progresu' : 'Reset game'}
                            </button>
                        )}
                    </div>
                </div>
