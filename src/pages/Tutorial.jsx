...
const ArrowLeft = () => (
    <img src="/images/bulta_simbols.png" alt="Arrow" className="w-12 h-12 object-contain" />
);
const Lightbulb = () => (
    <img src="/images/spuldze_simbols.png" alt="Lightbulb" className="w-12 h-12 object-contain" />
);
const Paragraph = () => (
    <img src="/images/extrainfo_simbols.png" alt="Paragraph" className="w-12 h-12 object-contain" />
);
const HelpCircle = () => (
    <img src="/images/jautajumzime_simbols.png" alt="Help" className="w-12 h-12 object-contain" />
);
    ...
    return (
        <Layout>
            <Card className="flex flex-col items-center relative overflow-hidden">
                <div className="absolute inset-0 bg-[url('/images/koka_siena.png')] bg-cover bg-center opacity-70 pointer-events-none" />
                ...
                <div className="relative z-10 w-full flex flex-col items-center">
                    ...
                    <div className="w-full max-w-[1154px] space-y-6 text-center">
                        ...
                        <div className="flex flex-col items-center gap-8 py-4">
                            ...
                            {/* Description Text */}
                            <div
                                className="w-full flex justify-center items-center -mt-15 py-18 px-8 bg-center bg-no-repeat bg-[length:100%_100%]"
                                style={{ backgroundImage: "url('/images/Papirs_vertikali.png')" }}
                            >
                                <p className="text-gray-900 leading-relaxed text-center whitespace-pre-line font-medium text-xl">
