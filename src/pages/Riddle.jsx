...
const Riddle = () => {
    ...
    const checkAnswer = () => {
        ...
        const correctAnswer = language === 'lv' ? ["bergfrīds", "bergfrids"] : ["bergfreid"];
        const isTextCorrect = correctAnswer.includes(finalAnswer.trim().toLowerCase());
                                ...
                                <div key={tIndex} className="flex items-end flex-nowrap mx-1 sm:mx-2">
                                    {token.chars.map(({ char, index }) => {
                                        ...
                                        if (seal1_numbers.includes(displayNumber)) {
                                            sealImage = '/images_4/zimogs_1.png';
                                        } else if (seal2_numbers.includes(displayNumber)) {
                                            sealImage = '/images_4/zimogs_2.png';
                                        } else if (seal3_numbers.includes(displayNumber)) {
                                            sealImage = '/images_4/zimogs_3.png';
                                        }
                                        ...
                                        return (
                                            <div key={index} className="flex flex-col items-center gap-1 mx-[1px] sm:mx-[2px]">
                                                <input
                                                    ...
                                                    style={{ backgroundImage: "url('/images_2/mazs_papirs.png')" }}
                                                />
    ...
    return (
        <Layout>
            <Card className="flex flex-col items-center relative overflow-hidden">
                <div className="absolute inset-0 bg-[url('/images_3/akmens_bruga_siena.png')] bg-cover bg-center opacity-70 pointer-events-none" />
                <div className="relative z-10 flex flex-col items-center w-full">
                    ...
                    {/* Feedback Message */}
                    {feedback === 'incorrect' && (
                        <div className="mt-2 mb-4 p-3 rounded-lg font-bold animate-pulse w-full text-center bg-red-100 text-red-600">
