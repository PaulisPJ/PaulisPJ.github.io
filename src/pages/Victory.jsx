...
const Victory = () => {
    ...
    const generatePDF = () => {
        ...
        img.onload = () => {
            ...
            if (language === 'lv') {
                doc.text(text, 105, 123, { align: 'center' });
            } else {
            ...
            <Card className="flex flex-col items-center justify-center p-6 min-h-[85vh] bg-[#FF6B00] relative overflow-hidden">
                ...
                <div className="relative z-10 w-full flex justify-center mt-6">
                    <button
                        ...
                        className="text-xl font-bold text-black underline relative z-10 active:scale-95 transform duration-100 font-serif italic"
                    >
