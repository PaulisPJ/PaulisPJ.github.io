        ...
        <Layout>
            <Card className="relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center w-full">
                    ...
                    >
                        <h1
                            className="font-medieval font-bold text-[clamp(30px,6.5vw,40px)] whitespace-pre-line text-center px-6 leading-tight select-none ml-5 mr-5"
                        >
                            {t('app_title')}
                        </h1>
                    </div>
                    ...
                    >
                        ...
                        <img
                            src="/images/TMR_logo_sais_horizontali_cutout.png"
                            alt="TMR Logo"
