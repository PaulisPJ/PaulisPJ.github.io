    ...
    return (
        <Layout>
            <Card className="relative overflow-hidden">
                <div className="absolute inset-0 bg-[url('/images/koka_siena.png')] bg-cover bg-center opacity-80 pointer-events-none" />
                <div className="relative z-10 flex flex-col items-center gap-6 text-center">
                    ...
                    <button
                        ...
                        style={{ backgroundImage: "url('/images/Title_paper.png')" }}
                    >
                        Latviešu
                    </button>
