...
const Layout = ({ children }) => {
    ...
    const showHeader = gameState.currentPage !== 'language' && gameState.currentPage !== 'menu' && gameState.currentPage !== 'victory';
                ...
                {showHeader && (
                    <div className="flex justify-between items-center mb-4 px-2">
                        {!(gameState.currentPage === 'tutorial' && !gameState.onboardingComplete) ? (
                            ...
                            >
                                <img
                                    src="/images_3/bulta_simbols.png"
                                    alt="Back"
                        ...
                        {gameState.currentPage !== 'tutorial' && !(gameState.currentPage === 'story' && !gameState.onboardingComplete) ? (
                            ...
                            >
                                <img
                                    src="/images_2/jautajumzime_simbols.png"
                                    alt="Help"
                                    className="w-12 h-12 object-contain"
                                />
                            </button>
